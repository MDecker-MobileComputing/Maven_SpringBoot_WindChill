...
public class WindChillRestController {
	 ...
	 * <br>
	 *
	 * Diese Methode sollte nur Code enthalten, der HTTP-spezifisch ist!
	 *
	 ...
	 *
	 * @return Ergebnis der Berechnung; das enthaltene {@code ErgebnisRecord}-Objekt
	 *         wird automatisch nach JSON umgewandelt.
	 *
	...
	public ResponseEntity<ErgebnisRecord> berechneWindChillTemperatur(
		...
		LOG.debug( "Berechnungsanfrage mit Temperatur={} und Windgeschwindigkeit={} erhalten.",
				   physTemperatur, windgeschwindigkeit );
		...
		LOG.info( "Windchill-Temperatur berechnet: {}" ,ergebnis );
